...
Aria.classDefinition({
	...
	$prototype : {
		...
		_applyConfig : function (conf) {
			...
			this.domElement = this._createDomElement((conf.tagDomElement) ? conf.tagDomElement : null);
		 ...
		 */
		_createDomElement : function (tagDomElement) {
			...
			(tagDomElement) ? tagDomElement.appendChild(domElement) : document.body.appendChild(domElement);
			return domElement;
		},
		...
		_getComputedStyle : function () {
			...
			if (this.conf.tagDomElement) {
				// need to adjust the position based on the tagDomElement
				var tagDomElementPosition = aria.utils.Dom.calculatePosition(this.conf.tagDomElement);
				computedStyle.top -= tagDomElementPosition.top;
				computedStyle.left -= tagDomElementPosition.left;
			}
		...
		_show : function () {
			...
			if (aria.core.Browser.isIE7 && !this.isOpen) {
				...
				(this.conf.tagDomElement)
						? this.conf.tagDomElement.appendChild(this.domElement)
