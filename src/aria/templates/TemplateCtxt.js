...
module.exports = Aria.classDefinition({
    ...
    $prototype : {
        ...
        initTemplate : function (cfg) {
            ...
            this._width = {};
            this._height = {};
            this.$setViewportWidth(ariaTemplatesLayout.realWidth(cfg.width));
            this.$setViewportHeight(ariaTemplatesLayout.realHeight(cfg.height));
         ...
         */
        $hdim : function (a, b, c) {
            return ariaTemplatesLayout.getSODim(this._width, a, b, c);
        },
         ...
         */
        $vdim : function (a, b, c) {
            return ariaTemplatesLayout.getSODim(this._height, a, b, c);
        },
        ...
        $setViewportWidth : function (width) {
            var so = this._width;
            ariaTemplatesLayout.setSOViewport(so, width);
        ...
        $setViewportHeight : function (height) {
            var so = this._height;
            ariaTemplatesLayout.setSOViewport(so, height);
        ...
        $setSizeCfg : function (width, height) {
            if (width) {
                ariaTemplatesLayout.setSOSizeCfg(this._width, width);
            }
            this._tpl.$width = this._width.value;
            if (height) {
                ariaTemplatesLayout.setSOSizeCfg(this._height, height);
            }
