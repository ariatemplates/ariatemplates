    ...
    Aria.classDefinition({
        ...
        $constructor : function (tplCtxt, cfg, options) {
            ...
            for (var i = 0; binding = bindings[i]; i++) {
                binding.callback = this._notifyDataChange;
            ...
            if (processingBind) {
                processingBind.callback = this._notifyProcessingChange;
                this.registerBinding(processingBind);
            }
            ...
            if (attributeBind) {
                attributeBind.callback = this._notifyAttributeChange;
                this.registerBinding(attributeBind);
            }
        },
        $destructor : function () {
