...
module.exports = Aria.classDefinition({
    ...
    $prototype : {
        ...
        __allowSectionsAsContainers : function () {
            var dangerouslyAllowSectionsAsContainers = ariaCoreEnvironmentEnvironment.checkApplicationSettings("templateSettings").dangerouslyAllowSectionsAsContainers;

            if (dangerouslyAllowSectionsAsContainers) {
                this.$logWarn(this.SECTIONS_AS_CONTAINERS);
            }
            return dangerouslyAllowSectionsAsContainers;
