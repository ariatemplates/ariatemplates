...
Aria.classDefinition({
	...
	$prototype : {
		...
		_inputWithFrameMarkup : function (out) {
			var cfg = this._cfg, innerPadding = this._skinObj.innerPadding, hts = this._helpTextSet, htc = this._skinObj.helpText, color = (aria.core.Browser.isIE7 || this._simpleHTML)
			...
			var inlineStyle = ['padding:', innerPadding.top, 'px ', innerPadding.right, 'px ', innerPadding.bottom,
					'px ', innerPadding.left, 'px;position:relative;margin:0;'];
			if (!this._simpleHTML) {
