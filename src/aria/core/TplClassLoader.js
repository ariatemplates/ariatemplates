...
(function () {
    ...
    /**
     * Regular expression to check if a template is already generated by the server.
     * @type RegExp
     * @private
     */
    ...
    /**
     * Evaluate the template's class definition coming from the generated class. <br />
     * The class definition might be null in case of error, in this case it has already been reported.<br />
     * In debug mode if the eval throws an error we try to parse the template again in order to log more information on
     * the syntax error. <br />
     ...
     * </pre>
     *
     * @param {Object} generatedClass The class generated by the Template Class Generator
    ...
    /**
     * Parse and generate a template's class
     * @param {Object} args Information about the template (classpath, logical path, ...)
     * @private
     */
