...
/**
 * Gives access to the RobotApplet, to generate mouse and keyboard low level inputs, screen captures and finding
 * patterns on the screen (with Sikuli). This is still experimental, and, by default, the RobotApplet is not distributed
 * with Aria Templates.
