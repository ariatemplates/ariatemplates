...
/**
 * Test cases for aria.utils.validators.Alpha
 */
Aria.classDefinition({
    $classpath : "test.aria.utils.validators.AlphaTestCase",
    $extends : "aria.jsunit.TestCase",
    $dependencies : ["aria.utils.validators.Alpha"],
    $prototype : {
        /**
         * Test case 1: tests valid use cases.
         */
        test_isValid : function () {
            var useCases = ["abc", "ABC"];
            var validator = new aria.utils.validators.Alpha();
            var test;
