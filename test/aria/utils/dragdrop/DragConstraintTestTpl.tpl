...
{Template {
  $classpath : "test.aria.utils.dragdrop.DragConstraintTestTpl",
  $css : ["test.aria.utils.dragdrop.TemplateDialogSkin", "test.aria.utils.dragdrop.DragDropCSS"]
} }

  {macro main ( )}
    <div id = "dialog-container" style="width: 769px; height: 450px;">
        <div id = "dialog-title">
            <span id="dialog-title-dialog-message">Handle</span>
        </div>
        <div id="dialog-message">
            <p>Drag me from the handle</p>
            <div><iframe width="1200px" height="900" frameborder="1" scrolling="no" src="http://www.bbc.co.uk"></iframe></div>
        </div>
    </div>
