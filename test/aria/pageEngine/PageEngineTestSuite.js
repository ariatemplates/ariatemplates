...
Aria.classDefinition({
    ...
    $constructor : function () {
        ...
        this.addTests("test.aria.pageEngine.pageEngine.moduleControllerService.ModuleControllerServiceTestCase");
        this.addTests("test.aria.pageEngine.contentProcessors.MarkdownProcessorTestCase");
