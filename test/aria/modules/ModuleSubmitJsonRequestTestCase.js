...
Aria.classDefinition({
    ...
    $prototype : {
        ...
        testAsyncAsync : function () {
            var sync = true;
            this.callSubmitJsonRequest("async", {}, {
                async : false
            }, {
                onRequest : function (req) {
                    this.assertEquals(req.url, "/test?moduleName=test/aria/modules/test&actionName=async&sessionId=");
                    this.assertFalse(req.async);
                },
                expectResponseSuccess : true,
                onResponse : function (res) {
