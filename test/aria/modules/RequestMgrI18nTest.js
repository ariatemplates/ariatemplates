...
Aria.classDefinition({
	...
	$dependencies : ["aria.modules.urlService.PatternURLCreationImpl",'aria.modules.RequestMgr','aria.modules.urlService.environment.UrlService'],
		...
		testAsynchI18nUrl1 : function() {
			aria.core.AppEnvironment.setEnvironment({
				urlService : {
					...
					args : [null, "http://www.amadeus.com:8080/xyz/${moduleName}/sampleResId;jsessionid=${sessionId}?locale=${locale}"]
				}
			}, null, true);
