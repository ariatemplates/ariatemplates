...
Aria.classDefinition({
    $classpath : "test.aria.templates.customization.reload.shared.SharedTestCase",
    $extends : "aria.jsunit.TemplateTestCase",
    $constructor : function () {
        this.$TemplateTestCase.constructor.call(this);

        this.setTestEnv({
            template : "test.aria.templates.customization.reload.shared.TemplateContainer"
        });
    ...
    $prototype : {
        ...
        _injectResponse : function (args) {
            if (args.req.url.indexOf("/CommonCSS.tpl.css?") > 0) {
        ...
        _reloadComplete : function () {
            ...
            var textLoaded = aria.templates.CSSMgr.__textLoaded["test.aria.templates.customization.reload.shared.CommonCSS"];
            this.assertTrue(textLoaded.text.indexOf("30pt") > 0, "Text size didn't change");
