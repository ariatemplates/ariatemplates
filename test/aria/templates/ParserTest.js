...
Aria.classDefinition({
	...
	$prototype : {
		...
		testParseTemplateWidget : function () {
			...
			aria.core.JsonValidator.check(tree, 'aria.templates.TreeBeans.Root');
			this.assertTrue(tree.content[0].name == "@aria:Button");// widget definition without white space between name and configuration
			this.assertTrue(tree.content[1].name == "@aria:Button");// prefered widget definition with white space between name and configuration
		},
