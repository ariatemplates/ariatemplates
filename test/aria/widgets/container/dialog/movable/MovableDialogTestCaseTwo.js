...
Aria.classDefinition({
    $classpath : "test.aria.widgets.container.dialog.movable.MovableDialogTestCaseTwo",
    ...
    $constructor : function () {
        ...
        this.setTestEnv({
            template : "test.aria.widgets.container.dialog.movable.MovableDialogTemplateTwo",
            data : this.data
        });
        this._position = {};
