...
Aria.classDefinition({
    ...
    $prototype : {
        runTemplateTest : function () {
            ...
            var domItems = Array.prototype.slice.call(self.getElementsByClassName(listContainer, "xListItem_std"), 0);
            var labelItems = [];
            for (var i = 0; i < domItems.length; i++) {
                labelItems[i] = aria.utils.String.trim(domItems[i].innerHTML);
            }
