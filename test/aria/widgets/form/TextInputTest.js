...
Aria.classDefinition({
    ...
    $prototype : {
        ...
        _testBinding : function () {
            ...
            this.assertTrue(tf.dom.getElementsByTagName('input')[0].value == "value", "Value not propagated to DOM");

            // change value through binding
            aria.utils.Json.setValue(array, 0, null);

            this.assertTrue(tf.dom.getElementsByTagName('input')[0].value == "", "Value not propagated to DOM");
