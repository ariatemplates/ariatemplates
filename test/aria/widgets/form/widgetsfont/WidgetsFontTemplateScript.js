...
Aria.tplScriptDefinition({
    $classpath : "test.aria.widgets.form.widgetsfont.WidgetsFontTemplateScript",
    $dependencies : ['aria.resources.handlers.LCResourcesHandler', 'aria.resources.handlers.LCRangeResourceHandler'],
