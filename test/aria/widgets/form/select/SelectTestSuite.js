...
Aria.classDefinition({
    $classpath : "test.aria.widgets.form.select.SelectTestSuite",
    $extends : "aria.jsunit.TestSuite",
    $constructor : function () {
        this.$TestSuite.constructor.call(this);

        this._tests = ["test.aria.widgets.form.select.sharedSelect.MainTemplateTestCase",
                ...
                "test.aria.widgets.form.select.nocontroller.NoControllerTestCase",
                "test.aria.widgets.form.select.mouseWheel.SelectMouseWheelRobotTestCase",
