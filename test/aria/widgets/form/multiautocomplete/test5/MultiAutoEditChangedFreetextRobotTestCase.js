...
Aria.classDefinition({
    $classpath : "test.aria.widgets.form.multiautocomplete.test5.MultiAutoEditChangedFreetextRobotTestCase",
    $extends : "test.aria.widgets.form.multiautocomplete.MultiAutoCompleteRobotBase",
    $prototype : {

        runTemplateTest : function () {
            this.clickAndType(["b", "[enter]", this.dropdownCloseCondition, "a", this.dropdownOpenCondition, "[enter]",
