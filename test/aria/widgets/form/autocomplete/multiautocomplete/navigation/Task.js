...
Aria.classDefinition({
    $classpath : "test.aria.widgets.form.autocomplete.multiautocomplete.navigation.Task",
     ...
     * Builds a new Task.
     *
     * The specifications object is more or less the same as what <code>aria.core.Sequencer.addTask</code> expects.
     *
     * General properties:
     * <ul>
     *     <li><code>parent</code> / <code>test.aria.widgets.form.autocomplete.multiautocomplete.navigation.Sequence</code>: the container of the task (only one type supported for now)</li>
     *     <li><code>name</code>,<code>desc</code> / <code>String</code>: the name (or description) of the task</li>
     * </ul>
     *
     * Callback properties:
     * <ul>
     *     <li><code>scope</code>, <code>context</code>: the context (<code>this</code>) of the function invoked by the task</li>
     *     <li><code>args</code> / <code>Array</code>: the arguments list of the function invoked by the task</li>
     *     <li><code>asynchronous</code> / <code>Boolean</code>: tells whether the function invoked by the task is asynchronous (<code>true</code>) or not (<code>false</code)</li>
    ...
    $prototype: {
        /**
         * Returns the function to be passed the actual underlying task.
         *
         * Behind the scenes a task definition as expected by <code>aria.core.Sequencer.addTask</code> is used.
         *
         * This method return a wrapper function around the one given in the specifications of the task, in order to take care of things such as:
         * <ul>
        ...
        /**
         * Tells whether the task is running or not.
         *
         * A task is considered being running as soon as the function returned by <code>getFn</code> has been invoked and until the method <code>end</code> has not been called.
         *
        ...
        /**
         * To be called by any underlying function to notify that it has finished, and thus that the task can be considered finished too.
         */
        end : function() {
