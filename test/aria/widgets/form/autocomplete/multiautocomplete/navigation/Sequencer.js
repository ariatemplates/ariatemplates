 ...
 *
 * Tasks are instance of <code>test.aria.widgets.form.autocomplete.multiautocomplete.navigation.Task</code>.
 *
 * A tree of tasks can be built using tasks containers, which are instances of <code>test.aria.widgets.form.autocomplete.multiautocomplete.navigation.Sequence</code>.
 *
...
Aria.classDefinition({
    ...
    $prototype : {
        /**
         * Builds and runs the whole tree of tasks.
         *
         * Specifications:
         * <ul>
         *     <li>
         *         <code>onend</code> / <code>Object</code>: arguments corresponding to <code>test.aria.widgets.form.autocomplete.multiautocomplete.navigation.Sequence.run</code>
         *         <ul>
         ...
         * </ul>
         *
         * @param[in] spec {Object} The specifications to build to root sequence and how to run it. See full description for more details.
         *
         ...
         * Sequence factory.
         *
         * A sequence contains a list of tasks. There are two types of tasks:
         * <ul>
         ...
         * @param[in] {Array} specs The list of elements to populate the sequence. It can be either a sequence specifications or a task specifications. See full description for more details.
         */
         ...
         *
         * <ul>
         *     <li><code>method</code> / <code>String</code>: correspond to the <code>fn</code> property of the actual task. The name of the property of the <code>scope</code> object that contains the reference to the actual function.</li>
