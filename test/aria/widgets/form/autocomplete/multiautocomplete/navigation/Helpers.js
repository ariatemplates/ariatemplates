...
Aria.classDefinition({
    $classpath : "test.aria.widgets.form.autocomplete.multiautocomplete.navigation.Helpers",
    ...
    $statics : {
        ...
        /**
         * Repeats an item a certain number of times to build an array.
         *
         * This results of an array whose size corresponds to the number of times the item was repeated.
         *
        ...
        /**
         * As for each but builds an array with the return value at each iteration and returns the whole.
         *
         * See <code>aria.utils.Array.forEach</code> for more information on the parameters.
         *
         * The only thing which is different here is that the return value of the provided callback function is meaningful since it is used to populate the output array.
         *
        ...
        /**
         * A factory for array creation.
         *
         * This function ensures to gave an array at output. However, the resulting array depends on the type of the output:
         * <ul>
         ...
         *
         * The native <code>splice</code> method is used behind, and in a generic way: this means that the given array object only has to behave like an array, not necessarily be an instance of it.
         *
