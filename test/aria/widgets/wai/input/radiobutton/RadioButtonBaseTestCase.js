...
module.exports = Aria.classDefinition({
    $classpath : "test.aria.widgets.wai.input.radiobutton.RadioButtonBaseTestCase",
    ...
    $prototype : {
        ...
        checkAccessibility : function (widget) {
            var radioWidget = this[widget + "WithLabel"];
            var focusedElement = radioWidget._getFocusableElement();
            ...
            if (!radioWidget._skinObj.simpleHTML) {
                // role is not added to the icon element
                this.assertNull(radioWidget._icon.getDom().getAttribute('aria-role'), "The role attribute should not be added to the icon element.");
            }
            ...
            // tick the radio
            aria.utils.Json.setValue(this.templateCtxt._tpl.data, "checkedValue", "a");
            ...
            // untick the radio
            aria.utils.Json.setValue(this.templateCtxt._tpl.data, "checkedValue", "b");
            ...
            // disable the radio
            aria.utils.Json.setValue(this.templateCtxt._tpl.data, "disableRadio", true);
            ...
            aria.utils.Json.setValue(this.templateCtxt._tpl.data, "disableRadio", false);
            ...
            this.assertFalsy(radioWidget.getLabel().id, "There is no id generated for the label element.");
        ...
        checkAccessibilityEnabled : function () {
            var radioWidget = this.widgetEnabledWithLabelHidden;
            ...
            // the value of attribute role should be radio
            this.assertEquals(focusedElement.getAttribute('role'), "radio", "checkAccessibilityEnabled: the attribute role should have the value radio.");

            if (!radioWidget._skinObj.simpleHTML) {
                var iconElement = radioWidget._icon.getDom();
