...
/**
 * Meta test, check that the test runner raises the exception in case of a timeout in `afterClass`. Since it's testing
 * itself, it needs some hacks.
 */
Aria.classDefinition({
    $classpath : "test.aria.jsunit.beforeAfter.TimeoutTestAfterClass",
    ...
    $destructor : function () {
        // if (and only if) there is "Error disposing test" raised, the below assertion has failed.
