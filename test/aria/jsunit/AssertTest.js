...
Aria.classDefinition({
    ...
    $prototype : {
        ...
        testAssertNotUndefined : function () {
            this.assertNotUndefined("", "assertNotUndefined: empty string not null");
            this.assertNotUndefined("A", "assertNotUndefined: string not null");
            this.assertNotUndefined(1, "assertNotUndefined: number not null");
            this.assertNotUndefined({}, "assertNotUndefined: empty object not null");
            this.__assertInverseOfAssert(this.assertNotUndefined, undefined, "assertNotUndefined: not undefined");
        },
        ...
        __assertInverseOfAssert : function (assertFunction, assertValues, optMsg) {
            ...
            this.raiseFailure = this.constructor.prototype.raiseFailure; // reset raiseFailure method for assertTrue to work as expected
